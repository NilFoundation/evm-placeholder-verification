...
library modular_permutation_argument_circuit3{
    ...
    bytes constant zero_indices = hex"01c001e002000000006000c001200160";
    ...
    function verify(
        ...
        uint256 V_P_value = basic_marshalling.get_uint256_be(blob, table_values_offset + 544);
        uint256 h = 1;
        uint256 g = 1;
        ...
        F[1] = mulmod(
            ...
            addmod(
                mulmod(basic_marshalling.get_uint256_be(blob, table_values_offset + 544 + 0x20), h, modulus),
