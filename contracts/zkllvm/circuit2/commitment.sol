...
library modular_commitment_scheme_circuit2 {
    ...
    bytes constant point_ids = hex"000100010001000100010001000100010002010002010001000103000000000002000000000000"; // 1 byte -- point id
    bytes constant poly_points_num = hex"0017000c00030001"; // 2 byte lengths
    bytes constant poly_ids = hex"00000040008000c001000140018001c002000240028002c003000340038003c004000440048004c005000540058000000040008000c001000140018001c002000240028002c00200024004000300"; // 2 byte poly_id 2 byte
...
unchecked {
		...
		///* eta points check */
		{
			...
			// Check keccak(points) 
			if ( bytes32(0x51988e675e0e30f2ab57136bad7c7c62f5551539866effc75463a41ece4d55c8) != keccak256(abi.encode(points))) {
				return false;
			}
		}
