...
library modular_commitment_scheme_circuit1 {
    ...
    uint256 constant _eta = 28736864833883158177013837056318150998163627060526434316963511340537397155672;
    bytes constant point_ids = hex"0001000100010001000100010001000100020100020100010001000000000002000000000000"; // 1 byte -- point id
    bytes constant poly_points_num = hex"0017000c0003"; // 2 byte lengths
    bytes constant poly_ids = hex"00000040008000c001000140018001c002000240028002c003000340038003c004000440048004c005000540058000000040008000c001000140018001c002000240028002c0020002400400"; // 2 byte poly_id 2 byte
...
unchecked {
		...
		///* eta points check */
		{
			...
			// Check keccak(points) 
			if ( bytes32(0x780adb05b6fe63bdce7952e353a1f186b1729ddad01da3dcbc56b5d5db982039) != keccak256(abi.encode(points))) {
				return false;
			}
		}
