...
library modular_permutation_argument_circuit1{
    ...
    bytes constant zero_indices = hex"008000a000c000e000000020";
    ...
    function verify(
        ...
        uint256 V_P_value = basic_marshalling.get_uint256_be(blob, table_values_offset + 256);
        uint256 h = 1;
        uint256 g = 1;
        ...
        F[1] = mulmod(
            ...
            addmod(
                mulmod(basic_marshalling.get_uint256_be(blob, table_values_offset + 256 + 0x20), h, modulus),
