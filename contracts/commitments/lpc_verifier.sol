...
//
//    function skip_proof_be(bytes calldata blob, uint256 offset) internal pure returns (uint256 result_offset)
//    {
//        // T_root
...
//    }
//
//    function get_z_i_from_proof_be(bytes calldata blob, uint256 offset, uint256 i)
//    internal pure returns (uint256 z_i) {
//        // 0x28 (skip T_root)
//        z_i = basic_marshalling.get_i_uint256_from_vector(blob, basic_marshalling.skip_octet_vector_32_be(offset), i);
//    }
//
//    function get_z_i_ptr_from_proof_be(bytes calldata blob, uint256 offset, uint256 i)
//    internal pure returns (uint256 z_i) {
//        // 0x28 (skip T_root)
//        z_i = basic_marshalling.get_i_uint256_ptr_from_vector(blob, basic_marshalling.skip_octet_vector_32_be(offset), i);
//    }
//
...
//    }
//
//    function get_z_i_from_proof_be_check(bytes calldata blob, uint256 offset, uint256 i)
//    internal pure returns (uint256 z_i) {
//        // 0x28 (skip T_root)
//        z_i = basic_marshalling.get_i_uint256_from_vector_check(blob, offset + 0x28, i);
//    }
//
//    function get_z_i_ptr_from_proof_be_check(bytes calldata blob, uint256 offset, uint256 i)
//    internal pure returns (uint256 z_i) {
//        // 0x28 (skip T_root)
//        z_i = basic_marshalling.get_i_uint256_ptr_from_vector_check(blob, offset + 0x28, i);
//    }
//
//    function get_z_0_ptr_from_proof_be_check(bytes calldata blob, uint256 offset)
//    internal pure returns (uint256 z_0_ptr) {
//        // 0x28 (skip T_root) + 8 (lenght)
//        assembly {
//            z_0_ptr := add(blob.offset, add(offset, 0x30))
...
//    }
//
//    function parse_verify_proof_be(bytes calldata blob, uint256 offset, uint256[] memory evaluation_points,
...
//        for (uint256 i = 0; i < local_vars.z.length;) {
//            local_vars.z[i] = get_z_i_from_proof_be(blob, offset, i);
//            unchecked { i++; }
//        }
//        fri_params.U = polynomial.interpolate(evaluation_points, local_vars.z, fri_params.modulus);
...
//            fri_params.V = polynomial.mul_poly(fri_params.V, a_poly, fri_params.modulus);
//            unchecked { j++; }
//        }
//        offset = skip_to_first_fri_proof_be(blob, offset);
//        for (uint256 round_id = 0; round_id < fri_params.lambda;) {
//            local_vars.status = fri_verifier.parse_verify_proof_be(blob, offset, tr_state, fri_params);
