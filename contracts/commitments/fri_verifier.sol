...
library fri_verifier {
    ...
    {
        // colinear_value
        result_offset = basic_marshalling.skip_uint256_be(
            blob,
            offset
        );
        // T_root
    ...
    {
        // colinear_value
        result_offset = basic_marshalling.skip_uint256_be_check(
            blob,
            offset
        );
        // T_root
        ...
        // p
        uint256 value_len;
        (value_len, result_offset) = basic_marshalling
        ...
        returns (bool result, uint256 proof_size)
    {
        ...
        // skip colinear_path
        proof_size +=
            merkle_verifier.skip_merkle_proof_be(
                blob,
                offset + proof_size
            ) -
            (offset + proof_size);
