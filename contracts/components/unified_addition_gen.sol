...
library unified_addition_component_gen_good {
    ...
    function evaluate_gates_be(
        ...
        assembly {
            ...
            mstore(add(gate_params, GATE_EVAL_OFFSET), 0)
            mstore(x1, 0)
            mstore(x1,addmod(mload(x1),mulmod(x3,mulmod(x3,get_W_i_by_rotation_idx(10,0,mload(x2)),modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,mulmod(x3,mulmod(x4,get_W_i_by_rotation_idx(10,0,mload(x2)),modulus),modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,mulmod(x3,get_W_i_by_rotation_idx(1,0,mload(x2)),modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(x3,get_W_i_by_rotation_idx(3,0,mload(x2)),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,mulmod(x4,mulmod(x3,get_W_i_by_rotation_idx(10,0,mload(x2)),modulus),modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(x4,mulmod(x4,get_W_i_by_rotation_idx(10,0,mload(x2)),modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(x4,get_W_i_by_rotation_idx(1,0,mload(x2)),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,mulmod(x4,get_W_i_by_rotation_idx(3,0,mload(x2)),modulus),modulus),modulus))
            ...
            mstore(x1, 0)
            mstore(x1,addmod(mload(x1),mulmod(0x2,mulmod(get_W_i_by_rotation_idx(1,0,mload(x2)),get_W_i_by_rotation_idx(10,0,mload(x2)),modulus),modulus),modulus))
            ...
            mstore(x1,addmod(mload(x1),mulmod(0x2,mulmod(x3,mulmod(get_W_i_by_rotation_idx(8,0,mload(x2)),mulmod(get_W_i_by_rotation_idx(1,0,mload(x2)),get_W_i_by_rotation_idx(10,0,mload(x2)),modulus),modulus),modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ecfffffffe,mulmod(x3,mulmod(get_W_i_by_rotation_idx(8,0,mload(x2)),mulmod(x3,x3,modulus),modulus),modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ecffffffff,mulmod(x4,mulmod(get_W_i_by_rotation_idx(8,0,mload(x2)),mulmod(get_W_i_by_rotation_idx(1,0,mload(x2)),get_W_i_by_rotation_idx(10,0,mload(x2)),modulus),modulus),modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x3,mulmod(x4,mulmod(get_W_i_by_rotation_idx(8,0,mload(x2)),mulmod(x3,x3,modulus),modulus),modulus),modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x1),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x1, 0)
            mstore(x1,addmod(mload(x1),mulmod(x3,mulmod(x4,mulmod(x4,mulmod(get_W_i_by_rotation_idx(10,0,mload(x2)),get_W_i_by_rotation_idx(10,0,mload(x2)),modulus),modulus),modulus),modulus),modulus))
            ...
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,mulmod(x3,mulmod(x4,mulmod(x4,get_W_i_by_rotation_idx(4,0,mload(x2)),modulus),modulus),modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,mulmod(x3,mulmod(x4,mulmod(x3,mulmod(get_W_i_by_rotation_idx(10,0,mload(x2)),get_W_i_by_rotation_idx(10,0,mload(x2)),modulus),modulus),modulus),modulus),modulus),modulus))
            ...
            mstore(x1,addmod(mload(x1),mulmod(x3,mulmod(x4,mulmod(x3,get_W_i_by_rotation_idx(4,0,mload(x2)),modulus),modulus),modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x1),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x1, 0)
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,mulmod(x3,mulmod(x4,mulmod(x4,mulmod(get_W_i_by_rotation_idx(4,0,mload(x2)),get_W_i_by_rotation_idx(10,0,mload(x2)),modulus),modulus),modulus),modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(x3,mulmod(x4,mulmod(x4,mulmod(x3,get_W_i_by_rotation_idx(10,0,mload(x2)),modulus),modulus),modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,mulmod(x3,mulmod(x4,mulmod(x4,get_W_i_by_rotation_idx(1,0,mload(x2)),modulus),modulus),modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,mulmod(x3,mulmod(x4,mulmod(x4,get_W_i_by_rotation_idx(5,0,mload(x2)),modulus),modulus),modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(x3,mulmod(x4,mulmod(x3,mulmod(get_W_i_by_rotation_idx(4,0,mload(x2)),get_W_i_by_rotation_idx(10,0,mload(x2)),modulus),modulus),modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,mulmod(x3,mulmod(x4,mulmod(x3,mulmod(x3,get_W_i_by_rotation_idx(10,0,mload(x2)),modulus),modulus),modulus),modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(x3,mulmod(x4,mulmod(x3,get_W_i_by_rotation_idx(1,0,mload(x2)),modulus),modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(x3,mulmod(x4,mulmod(x3,get_W_i_by_rotation_idx(5,0,mload(x2)),modulus),modulus),modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x1),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x1, 0)
            mstore(x1,addmod(mload(x1),mulmod(x3,mulmod(x4,mulmod(get_W_i_by_rotation_idx(3,0,mload(x2)),mulmod(get_W_i_by_rotation_idx(10,0,mload(x2)),get_W_i_by_rotation_idx(10,0,mload(x2)),modulus),modulus),modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,mulmod(x3,mulmod(x4,mulmod(get_W_i_by_rotation_idx(3,0,mload(x2)),x3,modulus),modulus),modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,mulmod(x3,mulmod(x4,mulmod(get_W_i_by_rotation_idx(3,0,mload(x2)),x4,modulus),modulus),modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,mulmod(x3,mulmod(x4,mulmod(get_W_i_by_rotation_idx(3,0,mload(x2)),get_W_i_by_rotation_idx(4,0,mload(x2)),modulus),modulus),modulus),modulus),modulus))
