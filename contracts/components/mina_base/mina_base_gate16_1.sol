...
//            mstore(add(gate_params, GATE_EVAL_OFFSET), 0)
            ...
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(10,2, mload(x2)),get_eval_i_by_rotation_idx(0,2, mload(x2)), modulus),modulus))
            ...
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(12,1, mload(x2)),get_eval_i_by_rotation_idx(0,2, mload(x2)), modulus),modulus))
            ...
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(11,2, mload(x2)),mulmod(get_eval_i_by_rotation_idx(9,0, mload(x2)),mulmod(get_eval_i_by_rotation_idx(9,0, mload(x2)),get_eval_i_by_rotation_idx(9,0, mload(x2)), modulus), modulus), modulus),modulus))
            ...
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(9,2, mload(x2)),mulmod(get_eval_i_by_rotation_idx(0,2, mload(x2)),get_eval_i_by_rotation_idx(9,0, mload(x2)), modulus), modulus),modulus))
            ...
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(12,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(0,2, mload(x2)),mulmod(get_eval_i_by_rotation_idx(8,1, mload(x2)),get_eval_i_by_rotation_idx(2,1, mload(x2)), modulus), modulus), modulus),modulus))
            ...
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(14,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(0,2, mload(x2)),mulmod(get_eval_i_by_rotation_idx(8,1, mload(x2)),get_eval_i_by_rotation_idx(2,1, mload(x2)), modulus), modulus), modulus),modulus))
            ...
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(13,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(10,0, mload(x2)),mulmod(get_eval_i_by_rotation_idx(10,0, mload(x2)),mulmod(get_eval_i_by_rotation_idx(10,0, mload(x2)),mulmod(get_eval_i_by_rotation_idx(8,1, mload(x2)),get_eval_i_by_rotation_idx(2,1, mload(x2)), modulus), modulus), modulus), modulus), modulus),modulus))
            ...
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(11,2, mload(x2)),mulmod(get_eval_i_by_rotation_idx(0,2, mload(x2)),mulmod(get_eval_i_by_rotation_idx(10,0, mload(x2)),mulmod(get_eval_i_by_rotation_idx(8,1, mload(x2)),get_eval_i_by_rotation_idx(2,1, mload(x2)), modulus), modulus), modulus), modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x1),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x1, 0)
            ...
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(1,0, mload(x2)),mulmod(get_eval_i_by_rotation_idx(0,2, mload(x2)),mulmod(get_eval_i_by_rotation_idx(8,1, mload(x2)),get_eval_i_by_rotation_idx(2,1, mload(x2)), modulus), modulus), modulus),modulus))
            ...
            mstore(x1,addmod(mload(x1),mulmod(0x2,mulmod(get_eval_i_by_rotation_idx(13,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(13,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(11,0, mload(x2)),mulmod(get_eval_i_by_rotation_idx(8,1, mload(x2)),get_eval_i_by_rotation_idx(2,1, mload(x2)), modulus), modulus), modulus), modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,mulmod(get_eval_i_by_rotation_idx(13,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(11,0, mload(x2)),mulmod(get_eval_i_by_rotation_idx(11,0, mload(x2)),mulmod(get_eval_i_by_rotation_idx(11,0, mload(x2)),mulmod(get_eval_i_by_rotation_idx(8,1, mload(x2)),get_eval_i_by_rotation_idx(2,1, mload(x2)), modulus), modulus), modulus), modulus), modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(13,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(0,2, mload(x2)),mulmod(get_eval_i_by_rotation_idx(11,0, mload(x2)),mulmod(get_eval_i_by_rotation_idx(8,1, mload(x2)),get_eval_i_by_rotation_idx(2,1, mload(x2)), modulus), modulus), modulus), modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x1),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x1, 0)
            ...
            mstore(x1,addmod(mload(x1),get_eval_i_by_rotation_idx(5,2, mload(x2)),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x1),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x1, 0)
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(8,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(2,1, mload(x2)),get_eval_i_by_rotation_idx(8,1, mload(x2)), modulus), modulus),modulus))
            ...
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(5,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(3,1, mload(x2)),get_eval_i_by_rotation_idx(5,1, mload(x2)), modulus), modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x1),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x1, 0)
            ...
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(5,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(4,1, mload(x2)),get_eval_i_by_rotation_idx(5,1, mload(x2)), modulus), modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x1),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x1, 0)
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(8,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(2,1, mload(x2)),get_eval_i_by_rotation_idx(0,0, mload(x2)), modulus), modulus),modulus))
            ...
            mstore(x1,addmod(mload(x1),mulmod(0x3fffffffffffffffffffffffffffffffffffffffffb8503e0ce645cc00000001,mulmod(get_eval_i_by_rotation_idx(5,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(3,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(3,1, mload(x2)),get_eval_i_by_rotation_idx(6,1, mload(x2)), modulus), modulus), modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(5,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(3,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(5,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(3,1, mload(x2)),get_eval_i_by_rotation_idx(6,1, mload(x2)), modulus), modulus), modulus), modulus),modulus))
            ...
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,mulmod(get_eval_i_by_rotation_idx(5,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(4,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(5,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(3,1, mload(x2)),get_eval_i_by_rotation_idx(6,1, mload(x2)), modulus), modulus), modulus), modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x3fffffffffffffffffffffffffffffffffffffffffb8503e0ce645cc00000000,mulmod(get_eval_i_by_rotation_idx(5,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(4,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(4,1, mload(x2)),get_eval_i_by_rotation_idx(6,1, mload(x2)), modulus), modulus), modulus),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(5,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(4,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(5,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(4,1, mload(x2)),get_eval_i_by_rotation_idx(6,1, mload(x2)), modulus), modulus), modulus), modulus),modulus))
            ...
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x1, 0)
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(8,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(2,1, mload(x2)),get_eval_i_by_rotation_idx(1,0, mload(x2)), modulus), modulus),modulus))
            ...
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(5,1, mload(x2)),mulmod(get_eval_i_by_rotation_idx(3,1, mload(x2)),get_eval_i_by_rotation_idx(7,1, mload(x2)), modulus), modulus),modulus))
            ...
            mstore(x1,addmod(mload(x1),get_eval_i_by_rotation_idx(8,1, mload(x2)),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x1),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
