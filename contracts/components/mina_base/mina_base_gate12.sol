...
library mina_base_gate12 {
    ...
    function evaluate_gate_be(
        ...
        assembly {
            ...
            mstore(add(gate_params, GATE_EVAL_OFFSET), 0)
            mstore(x1, 0)
            mstore(x1,addmod(mload(x1),mulmod(0x10000000000000000,get_eval_i_by_rotation_idx(2,0, mload(x2)),modulus),modulus))
            mstore(x1,addmod(mload(x1),get_eval_i_by_rotation_idx(1,0, mload(x2)),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x100000000000000000000000000000000,get_eval_i_by_rotation_idx(3,0, mload(x2)),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x1000000000000000000000000000000000000000000000000,get_eval_i_by_rotation_idx(4,0, mload(x2)),modulus),modulus))
            ...
            mstore(x1,addmod(mload(x1),0x40000000000000000000000000000000224698fc094cf91b325a61da00000002,modulus))
            mstore(x1,addmod(mload(x1),get_eval_i_by_rotation_idx(5,0, mload(x2)),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x10000000000000000,get_eval_i_by_rotation_idx(9,0, mload(x2)),modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x1),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x1, 0)
            ...
            mstore(x1,addmod(mload(x1),0x40000000000000000000000000000000224698fc094cf91abb73c9e9094cf91d,modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,get_eval_i_by_rotation_idx(9,0, mload(x2)),modulus),modulus))
            mstore(x1,addmod(mload(x1),get_eval_i_by_rotation_idx(6,0, mload(x2)),modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x10000000000000000,get_eval_i_by_rotation_idx(10,0, mload(x2)),modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x1),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x1, 0)
            ...
            mstore(x1,addmod(mload(x1),0x40000000000000000000000000000000224698fc094cf91a992d30ed00000002,modulus))
            ...
            mstore(x1,addmod(mload(x1),mulmod(0x10000000000000000,get_eval_i_by_rotation_idx(11,0, mload(x2)),modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x1),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x1, 0)
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,get_eval_i_by_rotation_idx(4,0, mload(x2)),modulus),modulus))
            mstore(x1,addmod(mload(x1),0x40000000000000000000000000000000224698fc094cf91ad92d30ed00000002,modulus))
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,get_eval_i_by_rotation_idx(11,0, mload(x2)),modulus),modulus))
            mstore(x1,addmod(mload(x1),get_eval_i_by_rotation_idx(8,0, mload(x2)),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x1),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x1, 0)
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,get_eval_i_by_rotation_idx(9,0, mload(x2)),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(9,0, mload(x2)),get_eval_i_by_rotation_idx(9,0, mload(x2)), modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x1),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x1, 0)
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,get_eval_i_by_rotation_idx(10,0, mload(x2)),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(10,0, mload(x2)),get_eval_i_by_rotation_idx(10,0, mload(x2)), modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x1),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x1, 0)
            mstore(x1,addmod(mload(x1),mulmod(0x40000000000000000000000000000000224698fc094cf91b992d30ed00000000,get_eval_i_by_rotation_idx(11,0, mload(x2)),modulus),modulus))
            mstore(x1,addmod(mload(x1),mulmod(get_eval_i_by_rotation_idx(11,0, mload(x2)),get_eval_i_by_rotation_idx(11,0, mload(x2)), modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x1),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
