...
library mina_scalar_gate1 {
    ...
    function evaluate_gate_be(
        ...
        assembly {
            ...
            mstore(x2,addmod(mload(x2),mulmod(get_eval_i_by_rotation_idx(7,0, mload(x1)),mulmod(get_eval_i_by_rotation_idx(7,0, mload(x1)),mulmod(get_eval_i_by_rotation_idx(7,0, mload(x1)),get_eval_i_by_rotation_idx(7,0, mload(x1)), modulus), modulus), modulus),modulus))
            ...
            mstore(x2,addmod(mload(x2),mulmod(get_eval_i_by_rotation_idx(8,0, mload(x1)),mulmod(get_eval_i_by_rotation_idx(8,0, mload(x1)),mulmod(get_eval_i_by_rotation_idx(8,0, mload(x1)),get_eval_i_by_rotation_idx(8,0, mload(x1)), modulus), modulus), modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x2),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x2, 0)
            ...
            mstore(x2,addmod(mload(x2),mulmod(get_eval_i_by_rotation_idx(9,0, mload(x1)),mulmod(get_eval_i_by_rotation_idx(9,0, mload(x1)),mulmod(get_eval_i_by_rotation_idx(9,0, mload(x1)),get_eval_i_by_rotation_idx(9,0, mload(x1)), modulus), modulus), modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x2),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x2, 0)
            ...
            mstore(x2,addmod(mload(x2),mulmod(get_eval_i_by_rotation_idx(10,0, mload(x1)),mulmod(get_eval_i_by_rotation_idx(10,0, mload(x1)),mulmod(get_eval_i_by_rotation_idx(10,0, mload(x1)),get_eval_i_by_rotation_idx(10,0, mload(x1)), modulus), modulus), modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x2),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x2, 0)
            ...
            mstore(x2,addmod(mload(x2),mulmod(get_eval_i_by_rotation_idx(11,0, mload(x1)),mulmod(get_eval_i_by_rotation_idx(11,0, mload(x1)),mulmod(get_eval_i_by_rotation_idx(11,0, mload(x1)),get_eval_i_by_rotation_idx(11,0, mload(x1)), modulus), modulus), modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x2),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x2, 0)
            ...
            mstore(x2,addmod(mload(x2),mulmod(get_eval_i_by_rotation_idx(12,0, mload(x1)),mulmod(get_eval_i_by_rotation_idx(12,0, mload(x1)),mulmod(get_eval_i_by_rotation_idx(12,0, mload(x1)),get_eval_i_by_rotation_idx(12,0, mload(x1)), modulus), modulus), modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x2),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x2, 0)
            ...
            mstore(x2,addmod(mload(x2),mulmod(get_eval_i_by_rotation_idx(13,0, mload(x1)),mulmod(get_eval_i_by_rotation_idx(13,0, mload(x1)),mulmod(get_eval_i_by_rotation_idx(13,0, mload(x1)),get_eval_i_by_rotation_idx(13,0, mload(x1)), modulus), modulus), modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x2),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x2, 0)
            ...
            mstore(x2,addmod(mload(x2),mulmod(get_eval_i_by_rotation_idx(14,0, mload(x1)),mulmod(get_eval_i_by_rotation_idx(14,0, mload(x1)),mulmod(get_eval_i_by_rotation_idx(14,0, mload(x1)),get_eval_i_by_rotation_idx(14,0, mload(x1)), modulus), modulus), modulus),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x2),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x2, 0)
            ...
            mstore(x2,addmod(mload(x2),get_eval_i_by_rotation_idx(4,0, mload(x1)),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x2),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x2, 0)
            ...
            mstore(x2,addmod(mload(x2),mulmod(0x2aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaac18465fd5bb87093b2d9f21600000000,mulmod(get_eval_i_by_rotation_idx(14,0, mload(x1)),mulmod(get_eval_i_by_rotation_idx(14,0, mload(x1)),get_eval_i_by_rotation_idx(14,0, mload(x1)), modulus), modulus),modulus),modulus))
            mstore(x2,addmod(mload(x2),get_eval_i_by_rotation_idx(5,0, mload(x1)),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x2),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
            mstore(x2, 0)
            ...
            mstore(x2,addmod(mload(x2),get_eval_i_by_rotation_idx(1,0, mload(x1)),modulus))
            mstore(add(gate_params, GATE_EVAL_OFFSET),addmod(mload(add(gate_params, GATE_EVAL_OFFSET)),mulmod(mload(x2),theta_acc,modulus),modulus))
            theta_acc := mulmod(theta_acc,mload(add(gate_params, THETA_OFFSET)),modulus)
