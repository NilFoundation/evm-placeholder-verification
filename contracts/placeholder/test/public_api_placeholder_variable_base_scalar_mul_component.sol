...
import "../verifier_variable_base_scalar_mul_component.sol";

contract TestPlaceholderVerifierVariableBaseScalarMul {
    ...
    function verify(
        ...
        require(
            placeholder_verifier_variable_base_scalar_mul_component.verify_proof_be(
                blob,
                vars.tr_state,
                vars.proof_map,
                vars.fri_params,
