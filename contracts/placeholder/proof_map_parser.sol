...
library placeholder_proof_map_parser {
    ...
    function parse_updated_be(bytes calldata blob, uint256 offset)
    internal pure returns (types.placeholder_updated_proof_map memory proof_map, uint256 proof_size){
