...
const modular = async (hre)=>{
    ...
    let minimial_modular = await ethers.getContract('zkEVMModular');
    accounts[minimial_modular.address] = await getAccount(minimial_modular.address, [
    ...
    let tx = await minimial_modular.test_modular(0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFn, {gasLimit: 30_000_000});
