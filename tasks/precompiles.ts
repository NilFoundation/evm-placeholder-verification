...
const precompiles = async (hre)=>{
    ...
    let minimial_precompiles = await ethers.getContract('zkEVMPrecompiles');
    accounts[minimial_precompiles.address] = await getAccount(minimial_precompiles.address, [
    ...
    let tx = await minimial_precompiles.test_expmod(2, [1, 2, 3, 0xFFFFFF], {gasLimit: 30_000_000});
