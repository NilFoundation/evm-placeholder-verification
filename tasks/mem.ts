...
const mem = async (hre)=>{
    ...
    let minimial_mem = await ethers.getContract('zkEVMMemInit');
    accounts[minimial_mem.address] = await getAccount(minimial_mem.address, [
    ...
    let tx = await minimial_mem.test_memory(113, 112, 0x112233445566, {gasLimit: 30_000_000});
