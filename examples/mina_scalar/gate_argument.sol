...
contract gate_argument_split_gen is IGateArgument{
    ...
    function evaluate_gates_be(
        ...
        (gate_params.gates_evaluation, gate_params.theta_acc) = gate12.evaluate_gate_be(gate_params);
        (gate_params.gates_evaluation, gate_params.theta_acc) = gate14.evaluate_gate_be(gate_params);
        (gate_params.gates_evaluation, gate_params.theta_acc) = gate16.evaluate_gate_be(gate_params);
        (gate_params.gates_evaluation, gate_params.theta_acc) = gate18.evaluate_gate_be(gate_params);
        (gate_params.gates_evaluation, gate_params.theta_acc) = gate22.evaluate_gate_be(gate_params);
