...
library gate3 {
    ...
    function evaluate_gate_be(
        ...
        assembly {
            ...
            mstore(add(gate_params, CONSTRAINT_EVAL_OFFSET), 0)
            terms:=0x1
            terms:=mulmod(terms, get_eval_i_by_rotation_idx(5,1, mload(add(gate_params, WITNESS_EVALUATIONS_OFFSET))), modulus)
            terms:=mulmod(terms, get_eval_i_by_rotation_idx(5,1, mload(add(gate_params, WITNESS_EVALUATIONS_OFFSET))), modulus)
            ...
            mstore(add(gate_params, CONSTRAINT_EVAL_OFFSET),addmod(mload(add(gate_params, CONSTRAINT_EVAL_OFFSET)),terms,modulus))
            terms:=0x100
            terms:=mulmod(terms, get_eval_i_by_rotation_idx(1,1, mload(add(gate_params, WITNESS_EVALUATIONS_OFFSET))), modulus)
            mstore(add(gate_params, CONSTRAINT_EVAL_OFFSET),addmod(mload(add(gate_params, CONSTRAINT_EVAL_OFFSET)),terms,modulus))
            terms:=0x40000000000000000000000000000000224698fc0994a8dd8c46eb2100000000
