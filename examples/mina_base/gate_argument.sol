...
contract gate_argument_split_gen is IGateArgument {
    ...
    function evaluate_gates_be(
        ...
        (local_vars.gates_evaluation, local_vars.theta_acc) = gate13.evaluate_gate_be(gate_params, local_vars);
        (local_vars.gates_evaluation, local_vars.theta_acc) = gate15.evaluate_gate_be(gate_params, local_vars);
        (local_vars.gate_eval, local_vars.theta_acc) = gate16.evaluate_gate_be(gate_params, local_vars);
        (local_vars.gates_evaluation, local_vars.theta_acc) = gate16_1.evaluate_gate_be(gate_params, local_vars);
