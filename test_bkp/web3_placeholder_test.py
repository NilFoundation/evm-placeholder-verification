...
def load_params(paramsfile, prooffile):
    ...
    if( 'log_file' in parsed_json) :
        ...
        params['log_file'] = 'placeholder_test.log'
...
def unified_addition_test():    
    ...
    do_placeholder_verification_test_via_transact_simple(
