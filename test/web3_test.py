...
def do_kimchi_verification_test_via_transact(test_contract_name, test_contract_path, linked_gates_entry_lib_name, linked_gates_libs_names, init_test_params_func):
    w3 = init_connection()
